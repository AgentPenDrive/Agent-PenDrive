...
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @var\langs\ufe\Polish.xml:LOADING_0
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @var\langs\ufe\Polish.xml:LOADING_1
CALL "$coms" /load_coms
IF NOT EXIST "%RAM%\KERNEL\com" GOTO ERROR_CANT_LOAD_COMS
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @var\langs\ufe\Polish.xml:LOADING_2
CALL "hal.bat"
IF %ERROR%==1 GOTO ERROR_CANT_LOAD_HAL
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @var\langs\ufe\Polish.xml:LOADING_3
CALL "$var" -load_defaults
IF NOT EXIST "%RAM%\KERNEL\var" GOTO ERROR_CANT_LOAD_VARS
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @var\langs\ufe\Polish.xml:LOADING_4
CALL "$lib" /dll -load_defaults
IF NOT EXIST "%RAM%\KERNEL\lib" GOTO ERROR_CANT_LOAD_LIBS
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @var\langs\ufe\Polish.xml:LOADING_5
