...
CLS
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @%SHARE%\langs\boot\ufe\%AP_LANG%.xml:X86_DIALOG_0
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @%SHARE%\langs\boot\ufe\%AP_LANG%.xml:X86_DIALOG_1
CALL "$mods" /load_mods
IF NOT EXIST "%RAM%\KERNEL\modules" GOTO ERROR_CANT_LOAD_MODS
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @%SHARE%\langs\boot\ufe\%AP_LANG%.xml:X86_DIALOG_2
CALL "sal.bat"
IF %ERROR%==1 GOTO ERROR_CANT_LOAD_SAL
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @%SHARE%\langs\boot\ufe\%AP_LANG%.xml:X86_DIALOG_3
CALL "$var" -load_defaults
IF NOT EXIST "%RAM%\KERNEL\var" GOTO ERROR_CANT_LOAD_VARS
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @%SHARE%\langs\boot\ufe\%AP_LANG%.xml:X86_DIALOG_4
CALL "$lib" /dll -load_defaults
IF NOT EXIST "%RAM%\KERNEL\lib" GOTO ERROR_CANT_LOAD_LIBS
:: -----------------------------------------------------------------------------
CALL "W.BAT" TEXT 18,20 @%SHARE%\langs\boot\ufe\%AP_LANG%.xml:X86_DIALOG_5
