...
:CHECK_PARAMS ==================================================================
IF "%1"=="/login" CALL "apd_files\modules\acces_mgr\includes\login.bat" %2 %3 %4 %5 %6 %7 %8 %9 
IF "%1"=="/forget_passwd" CALL "apd_files\modules\acces_mgr\includes\forget_passwd.bat" %2 %3 %4 %5 %6 %7 %8 %9
GOTO END
